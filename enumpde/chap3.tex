...
\section{Schwache Lösungen für PDEs}
...
\begin{df}[Koezivität] \label{3.20}
...
\begin{df}[Bilinearform/Linearform für PDEs zweiter Ordnung] \label{3.21}
	...
	\begin{align} \label{eq:3.4}
		a(u,v) &:= \int_\Omega (A \Nabla u) \cdot \Nabla u - (b \cdot \Nabla v) u + c u v \di[x], \\
	...
	\begin{note}
		\begin{itemize}
			\item
				...
				Wähle $u \in H^(\Omega)$ konstant $u = k \neq 0$, dann ist
				\[

...
\begin{df} \label{1.3} % 1.3
    Ein System von Teilmengen $\scr B$ eines topologischen Raumes heißt \emphdef{Basis} der Topologie, wenn jedes Element in $\scr B$ offen ist und sich jede offene Menge als Vereinigung von Mengen in $\scr B$ schreiben lässt.
...
\begin{df} \label{1.5}
    ...
    Ein Homöomorphismus $\phi: V \to U$ heißt \emphdef{Karte} von $M$.
...
\begin{df} \label{1.6}
    ...
    Eine Familie von Karten $\scr A = \Set{\phi_i: V_i \to U_i}_{i \in I}$ einer topologischen Mannigfaltigkeit $M$ heißt \emphdef{Atlas} von $M$, falls $\bigcup_{i \in I} V_i = M$.
    ...
    \end{note}
    Ein differenzierbarer Atlas $\scr A$ heißt \emphdef{maximal}, wenn für jeden differenzierbaren Atlas $\hat{\scr A} \supset \scr A$ folgt $\hat{\scr A} = \scr A$.
\end{df}
...
\begin{df} \label{1.8}
    ...
    Eine topologische Mannigfaltigkeit $M$ zusammen mit einer differenzierbaren Struktur heißt \emphdef{differenzierbare Mannigfaltigkeit}

...
\begin{df} \label{5.14}
    ...
    \end{math}
    Die \emph{Schnitte} von $\T^p_q M$ heißen \emphdef{$(p,q)$-Tensoren}, oder \emphdef[Tensor!kovariant]{$p$-fach kovariante} und \emphdef[Tensor!kontravariant]{$q$-fach kontravariante} Tensoren.
\end{df}
...
\begin{df} \label{5.16}
    ...
    Wir definieren die \emphdef{Verjüngung}, \emphdef{Kontraktion}, \emphdef{Spurbildung} von $(p,q)$-Tensoren als
    \begin{math}

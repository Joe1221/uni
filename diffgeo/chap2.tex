...
\begin{df}[Untermannigfaltigkeit] \label{2.3}
    ...
    \end{math}
    existiert (wobei für $k \in \Set{0, \dotsc, n}$ hier $\R^k \subset \R^n$ den Untervektorraum mit letzten $n-k$ Koordinaten gleich Null bezeichnet), dann heißt $M$ eine $k$-dimensionale \emphdef{Untermannigfaltigkeit} von $N$.
    \begin{nt*}

...
\begin{st}
    ...
    \begin{proof}
%        Trianguliere alle Facetten, der Graph bleibt planar (beachte Beispiel 11-Eck).
%        Starte mit einer äußeren Facette und nehme Facetten hinzu.
%        Als Invariante: Alle Facetten bleiben sternförmig.
%
%        Ist eine Facette sternförmig, so bleibt der Kern nicht-leer, wenn ein Dreieck hinzugefügt wird.
    \end{proof}
\end{st}

...
\begin{st}[Menger, 1929]
    ...
    \begin{proof}
        Sei $C$ ein $AB$-Separator, dann existieren höchstens $|C|$ knotendisjunkte $AB$-Pfade.

        Für die Umkehrung: Induktion nach $|E|$.
        ...
        Also gilt $|C| \le k-1$.
        Jetzt gilt $C \cup \Set{x}$ und $C \cup \Set{y}$ sind $AB$-Separatoren in $G$.
    \end{proof}
\end{st}

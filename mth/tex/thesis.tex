...
Das in den folgenden Tests genutzt, synthetisce $u^0$ findet sich in Abbildung \ref{fig:sample}.
...
\begin{itemize}
	...
	\begin{math}[numbered] \label{eq:stopres}
	    \underbrace{\||p| - m \cdot p\|_{L^2}}_{=:R_{mp}} + \underbrace{\|p - \nabla u\|_{L^2}}_{=:R_{pu}} + \underbrace{\|n - m\|_{L^2}}_{=:R_{nm}} < \epsilon_R.
	\end{math}
\end{itemize}

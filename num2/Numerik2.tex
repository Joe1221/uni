...
\newcommand{\im}{\ensuremath{\mathrm{i}}} 			      	% komplexe Einheit
...
\[
k_j=f(x_i+c_j h, y_i + h_i \sum_{l=1}^s a_{jl} k_l), \quad j=1,\ldots,s.
\]
\item Setze
\[
...
\[
-y(x_i),\ldots, y_{i-m+1}\approx y(x_{i-m+1}),\ldots, y_{i-m+1}\approx y(x_{i-m+1})
\]

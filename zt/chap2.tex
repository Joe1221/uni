...
\begin{df*}
	...
	Die Ordnung eines Elements $g \in G$, geschrieben $o(g)$ ist die kleinste Zahl $m \in \N$ mit $g^m = 1$.
\end{df*}
...
\begin{st} \label{2.3}
	...
	\begin{proof}
		...
		\begin{seg}{$G \isomorphic P_1 \times \dotsb \times P_k$}
			...
			Wegen $(|\tilde P_1|, |P_1|) = 1$, also $\tilde P_1 \cap P_1 = 1$ gilt nach \ref{2.4} $G \isomorphic P_1 \times \tilde P_1$ und somit induktiv $G \isomorphic P_1 \times P_2 \times \dotsb P_k$.
		\end{seg}
	\end{proof}
\end{st}
...
\begin{lem} \label{2.6}
	...
	In diesem Fall gibt dann auch genau $\phi(p^i)$ solche Elemente in $G$.
	\begin{proof}

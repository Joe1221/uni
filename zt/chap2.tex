...
\begin{df} \label{2.13}
	\begin{enumerate}[a)]
		\item
		Sei $b \in \Z, m \in \N$ mit $m > 1$ und $(b, m) = 1$, dann nennt man $b$ \emphdef{quadratischer Rest} $\bmod m$, wenn $x^2 \equiv b \bmod m$ eine Lösung in $U(\Z / m\Z)$ besitzt.
		\item
			Sei $p \in \P, p > 2$.
			Dann definiert man das \emphdef{Legendresymbol} für $b \in \Z$ durch
			\[

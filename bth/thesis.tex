...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            height=5cm,
            width=8cm,
            axis x line=middle, xlabel={$x$},
            axis y line=middle, ylabel={$y$},
            xmin=-2.5,xmax=2.4,
            ymin=-1.1,ymax=1.4,
            ticks=none,
        ]
            \addplot[draw=main1,smooth cycle,tension=0.7,
                postaction={decorate},
                decoration={markings,
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        ...
        \begin{tikzpicture}[>=stealth,label distance=-0.15cm]
            \begin{axis}[
                ...
                \addplot[color=main1,smooth cycle,tension=0.6,
                    postaction={decorate},
                    decoration={markings,
                        mark=at position 0.1 with {\arrow{stealth}},
                        mark=at position 0.3 with {\arrow{stealth}},
                    ...
                    { (1.8,0) (1.5,0.7) (-0.2,0.7) (-0.6,0) (-0.3,-0.7) (0.3,-0.7) (0.6,0) (0.9,0.3) (1.3,0) (1.55,-0.2) };
                \node[anchor=north east] at (axis cs:-0.6,0) {$+\frac{1}{2}$}; \fill[color=hl1] (axis cs:-0.6,0) circle (1pt);
                \node[anchor=north west] at (axis cs:0.6,0) {$+\frac{1}{2}$}; \fill[color=hl1] (axis cs:0.6,0) circle (1pt);
                \node[anchor=north] at (axis cs:1.3,0) {$-\frac{1}{2}$}; \fill[color=hl1] (axis cs:1.3,0) circle (1pt);
                \node[anchor=north ] at (axis cs:1.8,0) {$+\frac{1}{2}$}; \fill[color=hl1] (axis cs:1.8,0) circle (1pt);
            \end{axis}
        \end{tikzpicture}
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        ...
        \begin{tikzpicture}[>=stealth]
            ...
            \draw[->] (0,-1) to (0,1.3) node[anchor=north west] {$y$};
            ...
            \draw[->,draw=main1] (3,0) to [out=0,in=-90] (3.5,1);
        \end{tikzpicture}
...
\begin{algorithm} \label{thm:alg:idx}
    ...
    \begin{algorithmic}[1]
        ...
        \While{$\deg_y(q) > 0$}
            \State{$p \gets \rem_y(p,r)$} \Comment{$c(x) = 0$ auf $\_V \cup (V(q,r) \cap \Boundary\Gamma)$?}
            \State{Permutiere $p, q, r$ absteigend bezüglich $\deg_y$}

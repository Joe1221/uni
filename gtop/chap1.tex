...
\begin{df}
    ...
    Eine \emphdef{polygonale Isotopie} von $P$ und $P'$ ist gegeben durch eine Folge von $\Delta$-Zügen:
    \begin{math}
...
\begin{df}
    Ein Knoten $P = (v_1, \dotsc, v_n)$ in $\R^d$ heißt \emphdef{trivial}, wenn $P$ isotop ist zu einem Knoten $P' = (v_1',v_2',v_3')$, d.h. einem Dreieck.
\end{df}

...
\begin{df}[Vektorfeld längs $f: V \to \R^3$]
	...
	Man nennt das Vektorfeld \emphdef[Vektorfeld!tangential]{tangential}, wenn $x(u) \in T_u(f)$ für alle $u \in U$ und \emphdef[Vektorfeld!normal]{normal}, wenn $x(u) \in \Orthspace_u f$ für alle $u \in U$.
\end{df}

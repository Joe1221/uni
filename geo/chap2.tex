...
\begin{df}
	$c$ heißt \emphdef[Kurve!reguläre parametrisiert]{reguläre parametrisierte Kurve}, wenn $c$ als Abbildung stetig differenzierbar ist mit $\ddx[t]{c} \neq 0$ für alle $t \in I$.

	Die \emphdef{Tangente} in $t_0$ ist $c(t_0) + t \dot c(t_0)$, dies ist gerade der lineare Anteil der Taylorentwicklung von $c$ in $t_0$.

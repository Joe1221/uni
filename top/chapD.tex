...
Jeder metrische Raum $X$ erfüllt
\begin{enumerate}[widest=(\SepAxiom0)]
	\item[(\SepAxiom{0})]
...
Für topologische Räume gelten folgende Zusammenhänge zwischen den Trennungsaxiomen.
% fixme: drawing

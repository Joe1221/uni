...
\begin{theorem}[Definition] \label{thm:4.1}
...
\begin{theorem}[Satz] \label{thm:4.3}
  \begin{enum-arab}
  \item
    Homogener Fall ($g = 0$):
    \begin{enum-alph}
...
\begin{theorem}[Definition] \label{thm:4.4}
...
\begin{theorem}[Korollar: Folgerung] \label{thm:4.6}
  \begin{enum-arab}
  \item
    Im Fall $g = 0$:
    \begin{enum-alph}

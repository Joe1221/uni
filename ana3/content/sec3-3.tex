...
\begin{theorem}[Definition] \label{thm:3.1}
...
\begin{theorem}[Korollar: Folgerung] \label{thm:3.2}
  Für $a < c < b$ gilt
  %
  \begin{align*}
...
\begin{theorem}[Satz] \label{thm:3.3}
...
\begin{theorem}[Satz: Hauptsatz] \label{thm:3.5}
...
\begin{theorem}[Korollar: Folgerung] \label{thm:3.6}
...
\begin{theorem}[Satz: Picard-Lindelöf] \label{thm:3.7}

...
\begin{st} \label{3.2}
	...
	\end{enumerate}
	\begin{proof}
		\coursehref{blatt07.pdf}{Übungsaufgabe 7.2}
	\end{proof}
\end{st}
...
\begin{nt} \label{3.4}
	...
	\]
	\begin{proof}
		 Sei $x\in L$ beliebig. Dann folgt aus dem Projektionssatz (aus der Funktionalanalysis, siehe \coursehref{blatt07.pdf}{Übungsaufgabe 7.1}) eine eindeutige Zerlegung 
\[

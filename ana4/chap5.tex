	...
	\begin{proof}
		\begin{enumerate}[1)]
			\item
				...
				\end{enumerate}
			\item[2),3)]
				Siehe \coursehref{blatt13.pdf}{Übungsaufgabe 13.1}.
			\item[4)]
				\begin{enumerate}[a)]
					\item
...
\coursetimestamp{15}{7}{2013}

\begin{st}[Eigenschaften] \label{5.40}
...
\begin{nt}[Temperierte und Schwartzsche Distributionen]
...
\begin{st}[Multiplikation] \label{5.56}
...
\begin{nt}[zu $\scr D'(\R^n)$ und $\scr S'(\R^n)$] \label{5.63}

...
\begin{df}[Lebesgue-Integral]
	...
	\begin{enumerate}[1)]
		...
		\item
			...
			$f$ heißt \emph{integrierbar}, falls $\Re f$ und $\Im f$ integrierbar sind und endlich. 
			Dann gilt
			\[
...
\begin{df} \label{2.10}
	...
	\end{align*}
	Dann ist $\|\argdot\|_p$ eine Norm auf $L^p(\Omega, \Sigma, \my)$ (leicht zu zeigen).
		...
		\begin{seg}[$1 \le p < \infty$]
			...
			\begin{enumerate}[a)]
				...
				\item
					...
					Wegen $(f_j)$ Cauchy-Folge, konvergiert die Teilfolge ${f_j}_k \to f$ bezüglich $\|\argdot\|_p$.
					Also
					\[
						\|f_j - f\|_p 

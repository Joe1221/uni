...
\begin{df} \label{1.20}
	Die Darstellung ? des Operators $A$ heißt \emph{Spektraldarstellung} von $A$.
	Die Menge
	\[
		\sigma(A) := \_{\{\lambda \in \C : \lambda \text{ ist Eigenwert von $A$} \}}
	\]
	Ein Operator $A$, der durch die Darstellung ? gegeben ist, heißt \emph{diskreter Spektraloperator}.
	\begin{note}

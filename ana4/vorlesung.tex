...
\begin{nt} \label{1.15}
	...
	\begin{proof}
		Folgt direkt aus \ref{1.12} 3). Sei $ M $ definiert wie in \ref{1.12} 3), dann folgt zunächst $ LH(\{e_1,e_2,...\})\subset M \subset L $ und somit auch $ L=\overline{LH(\{e_1,e_2,...\})}\subset \bar M=M\subset L $, also $ M=L $.
	\end{proof}
\end{nt}
